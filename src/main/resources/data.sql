...
VALUES ('Juan', 'Perez', 'Full Stack Developer',
        ...
        'img/dev-gabriel.png', 5, 'juan.perez@example.com', '+5491112345678', 'https://linkedin.com/in/juanperez',
        'https://github.com/juanperez');

INSERT INTO skills (name, level_percentage, icon_class, personal_info_id)
VALUES ('Java', 90, 'img/logos/java.png', 1),
...
VALUES ('Portfolio Personal', 'Un portafolio web para mostrar mis habilidades y proyectos.',
        'img/projects/project2.jpg', 'https://github.com/myusername/my-portfolio', 1),
       ('Aplicación de E-commerce', 'Plataforma de comercio electrónico con carrito de compras y pasarela de pago.',
        'img/projects/project1.jpg', 'https://github.com/myusername/ecommerce-app', 1);




INSERT INTO users ( username, password, enabled) VALUES ('admin', '$2a$10$L0ODR7AwfJFSH1hfu6Ad5uNLRITu8sNoRi3WRtstyK5T787Sa53Zi', TRUE);